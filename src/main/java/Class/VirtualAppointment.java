...
public class VirtualAppointment extends Appointment{
    ...
    public VirtualAppointment(int appointment_Id, String title, String description, String appointmentMethod, String type, Timestamp start, Timestamp end, Timestamp create_Date, String created_By, Timestamp last_Update, String last_Updated_By, int patient_Id, int user_Id, int therapist_Id) {
